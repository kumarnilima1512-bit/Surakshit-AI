...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Intervention: {
      ...
      readonly status: CodecTypes['pg/text@1']['output'];
      readonly assignedOfficerId: CodecTypes['pg/int4@1']['output'];
      readonly targetDate: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    ...
    readonly LoginHistory: {
      ...
      readonly ipAddress: CodecTypes['pg/text@1']['output'] | null;
      readonly device: CodecTypes['pg/text@1']['output'];
      readonly status: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    ...
    readonly Recommendation: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly userId: CodecTypes['pg/int4@1']['output'];
      readonly type: 'SLEEP' | 'ACTIVITY' | 'WORKLOAD' | 'SOCIAL';
      readonly title: CodecTypes['pg/text@1']['output'];
    ...
    readonly Report: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly commanderId: CodecTypes['pg/int4@1']['output'];
      readonly type: CodecTypes['pg/text@1']['output'];
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly fromDate: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly toDate: CodecTypes['pg/timestamptz-string@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Intervention: {
      ...
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly assignedOfficerId: CodecTypes['pg/int4@1']['input'];
      readonly targetDate: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    ...
    readonly LoginHistory: {
      ...
      readonly ipAddress: CodecTypes['pg/text@1']['input'] | null;
      readonly device: CodecTypes['pg/text@1']['input'];
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly Notification: {
    ...
    readonly Report: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly commanderId: CodecTypes['pg/int4@1']['input'];
      readonly type: CodecTypes['pg/text@1']['input'];
      readonly name: CodecTypes['pg/text@1']['input'];
      readonly fromDate: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly toDate: CodecTypes['pg/timestamptz-string@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly followUp: {
              ...
              indexes: readonly [
                {
                  readonly name: 'followUp_userId_idx_a489d58a';
                  readonly prefix: 'followUp_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly intervention: {
              ...
              indexes: readonly [
                {
                  readonly name: 'intervention_userId_idx_a489d58a';
                  readonly prefix: 'intervention_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'intervention_assignedOfficerId_idx_00da72e1';
                  readonly prefix: 'intervention_assignedOfficerId_idx';
                  readonly columns: readonly ['assignedOfficerId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly loginHistory: {
              ...
              indexes: readonly [
                {
                  readonly name: 'loginHistory_userId_idx_a489d58a';
                  readonly prefix: 'loginHistory_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'loginHistory';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly recommendation: {
              ...
              indexes: readonly [
                {
                  readonly name: 'recommendation_userId_idx_a489d58a';
                  readonly prefix: 'recommendation_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly report: {
              ...
              indexes: readonly [
                {
                  readonly name: 'report_commanderId_idx_88873fd5';
                  readonly prefix: 'report_commanderId_idx';
                  readonly columns: readonly ['commanderId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly unitAssignment: {
              ...
              indexes: readonly [
                {
                  readonly name: 'unitAssignment_unitId_idx_be785412';
                  readonly prefix: 'unitAssignment_unitId_idx';
                  readonly columns: readonly ['unitId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'unitAssignment_personnelId_idx_3649ff23';
                  readonly prefix: 'unitAssignment_personnelId_idx';
                  readonly columns: readonly ['personnelId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'unitAssignment';
                    readonly columns: readonly ['unitId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly welfareNote: {
              ...
              indexes: readonly [
                {
                  readonly name: 'welfareNote_personnelId_idx_3649ff23';
                  readonly prefix: 'welfareNote_personnelId_idx';
                  readonly columns: readonly ['personnelId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'welfareNote_authorId_idx_e47547ed';
                  readonly prefix: 'welfareNote_authorId_idx';
                  readonly columns: readonly ['authorId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'welfareNote';
                    readonly columns: readonly ['personnelId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            readonly PersonnelStatus: {
              ...
              readonly values: readonly ['ACTIVE', 'ON_LEAVE', 'INACTIVE'];
            };
            readonly RecommendationType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['SLEEP', 'ACTIVITY', 'WORKLOAD', 'SOCIAL'];
            };
            readonly Role: {
              readonly kind: 'valueSet';
      ...
      readonly public: {
        readonly models: {
          ...
          readonly Intervention: {
            ...
            readonly relations: {
              readonly assignedOfficer: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['assignedOfficerId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly user: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly status: { readonly column: 'status' };
                readonly assignedOfficerId: { readonly column: 'assignedOfficerId' };
          ...
          readonly Report: {
            ...
            readonly relations: {
              readonly commander: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['commanderId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly commanderId: { readonly column: 'commanderId' };
                readonly type: { readonly column: 'type' };
          ...
          readonly UnitAssignment: {
            ...
            readonly relations: {
              readonly personnel: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['personnelId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly unit: {
          ...
          readonly User: {
            ...
            readonly relations: {
              ...
              readonly assignedInterventions: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'Intervention';
                };
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['assignedOfficerId'];
                };
              };
              readonly auditLogs: {
                readonly to: {
              ...
              readonly reports: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['commanderId'];
                };
              };
              readonly unitAssignments: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'UnitAssignment';
                };
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['personnelId'];
                };
              };
              readonly welfareNotes: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'WelfareNote';
                };
        ...
        readonly enum: {
          ...
          readonly RecommendationType: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'SLEEP'; readonly value: 'SLEEP' },
              { readonly name: 'ACTIVITY'; readonly value: 'ACTIVITY' },
              { readonly name: 'WORKLOAD'; readonly value: 'WORKLOAD' },
