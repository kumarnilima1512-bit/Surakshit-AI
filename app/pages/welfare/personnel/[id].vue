<!--
  ...
  Responsive Welfare Officer personnel detail page.
-->
...
/* ======================================================================
   API CONTRACT
   ----------------------------------------------------------------------
   GET  /api/welfare/personnel/:id
   POST /api/welfare/personnel/:id/note        { text: string }
   POST /api/welfare/personnel/:id/follow-up   { date: string }
   ====================================================================== */
...
const {
  ...
  () => `/api/welfare/personnel/${personnelId.value}`,
)
...
async function submitNote() {
  ...
  try {
    await $fetch(
      `/api/welfare/personnel/${personnelId.value}/note`,
      {
        method: 'POST',
        body: { text },
      },
...
async function scheduleFollowUp() {
  ...
  try {
    await $fetch(
      `/api/welfare/personnel/${personnelId.value}/follow-up`,
      {
        method: 'POST',
        body: {
...
<template>
  <div
    class="min-h-screen min-w-0 bg-[#0b1220] p-4 text-slate-100 sm:p-6"
  >
    ...
    <NuxtLink
      ...
      class="inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold text-slate-300 transition-colors hover:bg-white/10 hover:text-white"
    >
      <ArrowLeft :size="14" />
      Back to Personnel
    </NuxtLink>
    ...
    <div
      v-if="loading"
      class="mt-4 flex items-center justify-center rounded-2xl border border-white/5 bg-[#0d1526] p-10 sm:p-16"
    >
      <div
    ...
    >
      ...
      <p
        class="max-w-xl text-xs leading-5 text-slate-400"
      >
        ...
        >
          /api/welfare/personnel/{{ personnelId }}
        </code>
      </p>
    ...
    <template v-else-if="data">
      ...
      <div
        class="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-4"
      >

        <!-- Profile -->
        <div
          class="rounded-2xl border border-white/5 bg-[#0d1526] p-4 sm:p-5 xl:col-span-2"
        >
          <div
          ...
          >
            ...
            <div class="min-w-0">
              ...
              <p
                class="mt-1 flex items-center gap-1.5 text-[11px] font-semibold text-emerald-400"
              >
                <span
            ...
            <!-- Risk -->
            <span
              class="w-fit shrink-0 rounded-md px-2.5 py-1 text-[11px] font-bold sm:ml-auto"
              :class="[
          ...
          <!-- Profile metadata -->
          <div
            class="mt-4 grid grid-cols-1 gap-3 border-t border-white/5 pt-4 text-xs sm:grid-cols-3"
          >
            <div>
              ...
              <p
                class="mt-0.5 font-semibold text-slate-200"
              >
                {{ data.id }}
              </p>
            </div>
        ...
        >
          ...
          <p
            class="mt-3 text-lg font-extrabold text-white"
          >
      ...
      >
        ...
        >
          ...
          <div
            v-else
            class="mt-4 flex h-48 items-center justify-center text-xs text-slate-500"
          >
          ...
          >
            Swipe horizontally to view the complete trend.
          </p>
            ...
            >
              ...
              <tbody>
                ...
                >
                  ...
                  <td
                    class="py-2.5 font-semibold text-slate-200"
                  >
                    {{ row.score }}
                  </td>
  ...
  >
    —
          ...
          <p
            class="mt-2 text-[10px] text-slate-600 sm:hidden"
          >
            Swipe horizontally to view assessment details.
          </p>
        </div>
        ...
        <div class="min-w-0 space-y-4">
          ...
          >
            ...
            <input
              ...
              type="date"
              class="mt-3 w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2.5 text-xs text-slate-200 outline-none focus:border-emerald-500/50"
            >
            ...
            <button
              ...
              class="mt-2 w-full rounded-lg bg-blue-600 py-2.5 text-xs font-semibold text-white hover:bg-blue-500 disabled:opacity-50"
            >
              {{
                schedulingFollowUp
                  ? 'Scheduling…'
          ...
          >
            ...
            <textarea
              v-model="noteDraft"
              rows="3"
              placeholder="Add a welfare note…"
              class="mt-3 w-full resize-none rounded-lg border border-white/10 bg-white/5 px-3 py-2.5 text-xs text-slate-200 placeholder-slate-500 outline-none focus:border-emerald-500/50"
            ></textarea>
            ...
            <button
              ...
              "
              @click="submitNote"
              class="mt-2 w-full rounded-lg bg-violet-600 py-2.5 text-xs font-semibold text-white hover:bg-violet-500 disabled:opacity-50"
            >
              {{
                savingNote
                  ? 'Saving…'
            ...
            <!-- Notes list -->
            <div
              class="mt-4 space-y-3 border-t border-white/5 pt-3"
            >
              <div
                v-if="!data.welfareNotes.length"
              ...
              <div
                v-for="(
                  note, i
                ) in data.welfareNotes"
                :key="i"
                class="rounded-lg bg-white/[0.02] p-2.5 text-xs"
              >
                <p
                  class="break-words leading-relaxed text-slate-200"
                >
                  {{ note.text }}
                </p>
